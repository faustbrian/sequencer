...
final readonly class SequentialOrchestrator implements Orchestrator
{
    ...
    private function executeOperation(array $task, bool $forceSync = false, bool $forceAsync = false, ?string $queue = null): array
    {
        ...
        if ($isAsync) {
            $this->dispatchAsync($operation, $operationPath, $record, $queue);
     ...
     */
    private function dispatchAsync(Operation $operation, string $operationPath, OperationModel $record, ?string $queue = null): void
    {
