 ...
 * @method static DeferredOperationModel                                     defer(class-string<DeferredOperation>|string $operation, array<string, mixed> $payload, DateTimeInterface $dueAt, ?int $maxAttempts = null)
