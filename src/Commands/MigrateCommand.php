...
final class MigrateCommand extends Command
{
     ...
     *
     * @throws Throwable When the migrator encounters errors during operation transfer or
     ...
     *
     * Validates source table accessibility, counts pending and already-migrated operations,
     * displays migration preview, prompts for confirmation (unless --force or --dry-run),
     * executes migration via OneTimeOperationsMigrator, and displays comprehensive results
     * including operations migrated, skipped duplicates, and any errors encountered.
     *
     * @throws Throwable When source table is inaccessible, migrator initialization fails,
     *                   or database operations encounter errors
     *
     * @return int Command exit code (self::SUCCESS or self::FAILURE)
     */
