 ...
 * - name: operation filename with .php extension (appended if missing from source)
...
final class OneTimeOperationsMigrator implements Migrator
{
    ...
    private function operationExists(string $operationName): bool
    {
        ...
        $nameWithoutPhp = str_ends_with($operationName, '.php') ? substr($operationName, 0, -4) : $operationName;
