 ...
 * @property null|string                     $executed_by_id   Polymorphic ID of executor
 * @property null|string                     $executed_by_type Polymorphic type of executor
 * @property null|Model                      $executedBy       Who executed this operation
...
final class Operation extends Model
{
     ...
     *
     * Disabled because the model uses custom timestamp fields (executed_at, completed_at, etc.)
     * instead of Laravel's standard created_at and updated_at fields. This provides more
     * granular tracking of operation lifecycle events.
     *
     * @var bool
     */
    ...
    /**
     * Get the polymorphic executor of this operation.
     *
     ...
     *
     * @return MorphTo<Model, $this> Polymorphic relation to the executor entity
     */
