...
final class OperationBuilder extends Builder
{
    ...
    /**
     * Scope query to operations executed by specific actor.
     *
     * Filters operations executed by a specific polymorphic entity (User, System, etc.).
     *
     * @param  Model $actor The entity that executed the operation
     * @return $this
     */
    public function byActor(Model $actor): self
    {
        return $this->where('actor_type', $actor->getMorphClass())
