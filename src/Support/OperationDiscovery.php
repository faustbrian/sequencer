...
final class OperationDiscovery
{
     ...
     *                                                                                   operation name without .php extension, extracted timestamp (YYYY_MM_DD_HHMMSS), and absolute path
     */
     ...
     *
     * @return list<string> Operation names that have been successfully completed
     */
     ...
     * filename for chronological ordering with migrations. Operation name is stored
     * without .php extension.
     *
     * @return list<array{class: string, name: string, timestamp: string, path: string}>
     *                                                                                   Discovered operations with file path (in 'class' key), operation name without .php, extracted
