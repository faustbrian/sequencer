...
return new class() extends Migration
{
    ...
    public function up(): void
    {
        ...
        $morphType = MorphType::tryFrom(config('sequencer.morph_type', 'string')) ?? MorphType::String;
        ...
        Schema::create(config('sequencer.table_names.operations', 'operations'), function (Blueprint $table) use ($primaryKeyType, $morphType): void {
            ...
            $table->string('type')->comment('Execution type');
            $table->string('state')->comment('Current execution state');
            ...
            $table->index(['actor_type', 'actor_id'], 'operations_actor_idx');
