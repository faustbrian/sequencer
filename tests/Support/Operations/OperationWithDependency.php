...
final readonly class OperationWithDependency implements HasDependencies, Operation
{
    ...
    public function handle(): void
    {
        if ($this->marker !== null) {
            ...
            throw_if($this->dependency && !file_exists(storage_path('framework/testing/'.str_replace(['2024_01_01_000000_', '2024_01_01_000001_', '.php'], ['', '', ''], $this->dependency).'_executed')), Exception::class, 'Dependency did not execute first');
