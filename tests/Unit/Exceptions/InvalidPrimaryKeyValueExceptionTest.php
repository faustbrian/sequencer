...
describe('InvalidPrimaryKeyValueException', function (): void {
    describe('Happy Path - UUID Exception Creation', function (): void {
        test('creates exception with nonStringUuid factory method for integer value', function (): void {
            // Arrange & Act
            $exception = InvalidPrimaryKeyValueException::nonStringUuid(123);
        ...
        test('exception message includes type information for array', function (): void {
            // Arrange & Act
            $exception = InvalidPrimaryKeyValueException::nonStringUuid(['id' => 1]);
        ...
        test('exception message includes type information for object', function (): void {
            // Arrange & Act
            $exception = InvalidPrimaryKeyValueException::nonStringUuid(
                new stdClass(),
            );
        ...
        test('exception message includes type information for null', function (): void {
            // Arrange & Act
            $exception = InvalidPrimaryKeyValueException::nonStringUuid(null);
        ...
        test('exception message includes type information for boolean', function (): void {
            // Arrange & Act
            $exception = InvalidPrimaryKeyValueException::nonStringUuid(true);
        ...
        test('exception message includes type information for double', function (): void {
            // Arrange & Act
            $exception = InvalidPrimaryKeyValueException::nonStringUuid(3.14);
    ...
    describe('Happy Path - ULID Exception Creation', function (): void {
        test('creates exception with nonStringUlid factory method for integer value', function (): void {
            // Arrange & Act
            $exception = InvalidPrimaryKeyValueException::nonStringUlid(456);
        ...
        test('exception message includes type information for array', function (): void {
            // Arrange & Act
            $exception = InvalidPrimaryKeyValueException::nonStringUlid(['id' => 1]);
        ...
        test('exception message includes type information for object', function (): void {
            // Arrange & Act
            $exception = InvalidPrimaryKeyValueException::nonStringUlid(
                new stdClass(),
            );
        ...
        test('exception message includes type information for null', function (): void {
            // Arrange & Act
            $exception = InvalidPrimaryKeyValueException::nonStringUlid(null);
        ...
        test('exception message includes type information for boolean', function (): void {
            // Arrange & Act
            $exception = InvalidPrimaryKeyValueException::nonStringUlid(false);
        ...
        test('exception message includes type information for double', function (): void {
            // Arrange & Act
            $exception = InvalidPrimaryKeyValueException::nonStringUlid(2.718);
    ...
    describe('Edge Cases - UUID Exceptions', function (): void {
        ...
        test('exception trace is populated when thrown', function (): void {
            // Arrange & Act
            try {
                throw InvalidPrimaryKeyValueException::nonStringUuid(123);
            } catch (InvalidPrimaryKeyValueException $invalidPrimaryKeyValueException) {
                // Assert
                expect($invalidPrimaryKeyValueException->getTrace())->toBeArray();
                expect($invalidPrimaryKeyValueException->getTrace())->not->toBeEmpty();
            }
        });
        ...
        test('handles resource type correctly', function (): void {
            ...
            // Act
            $exception = InvalidPrimaryKeyValueException::nonStringUuid($resource);
    ...
    describe('Edge Cases - ULID Exceptions', function (): void {
        ...
        test('exception trace is populated when thrown', function (): void {
            // Arrange & Act
            try {
                throw InvalidPrimaryKeyValueException::nonStringUlid(456);
            } catch (InvalidPrimaryKeyValueException $invalidPrimaryKeyValueException) {
                // Assert
                expect($invalidPrimaryKeyValueException->getTrace())->toBeArray();
                expect($invalidPrimaryKeyValueException->getTrace())->not->toBeEmpty();
        ...
        test('handles resource type correctly', function (): void {
            ...
            // Act
            $exception = InvalidPrimaryKeyValueException::nonStringUlid($resource);
    ...
    describe('Edge Cases - Different Value Types', function (): void {
        ...
        test('handles nested array for UUID', function (): void {
            // Arrange & Act
            $exception = InvalidPrimaryKeyValueException::nonStringUuid([['nested' => 'value']]);
        ...
        test('handles nested array for ULID', function (): void {
            // Arrange & Act
            $exception = InvalidPrimaryKeyValueException::nonStringUlid([['nested' => 'value']]);
        ...
        test('handles zero integer for UUID', function (): void {
            // Arrange & Act
            $exception = InvalidPrimaryKeyValueException::nonStringUuid(0);
        ...
        test('handles zero integer for ULID', function (): void {
            // Arrange & Act
            $exception = InvalidPrimaryKeyValueException::nonStringUlid(0);
    ...
    describe('Sad Path - Exception Handling', function (): void {
        test('UUID exception can be caught with InvalidArgumentException type', function (): void {
            // Arrange & Act & Assert
            expect(fn () => throw InvalidPrimaryKeyValueException::nonStringUuid(123))
                ->toThrow(InvalidArgumentException::class);
        });

        test('ULID exception can be caught with InvalidArgumentException type', function (): void {
            // Arrange & Act & Assert
            expect(fn () => throw InvalidPrimaryKeyValueException::nonStringUlid(456))
                ->toThrow(InvalidArgumentException::class);
        });
    ...
    describe('Edge Cases - Message Format Consistency', function (): void {
        ...
        test('ULID message mentions ULID specifically', function (): void {
            // Arrange & Act
            $exception = InvalidPrimaryKeyValueException::nonStringUlid(123);
