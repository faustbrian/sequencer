...
return new class implements Operation {
    public function handle(): void {
        throw OperationFailedException::forCoverage();
    }
};
PHP;
            ...
            expect(Artisan::output())->toContain('Failed to process migrations and operations:');
...
return new class implements Operation {
    public function handle(): void {
        throw OperationFailedException::verboseExceptionTest();
    }
};
PHP;
