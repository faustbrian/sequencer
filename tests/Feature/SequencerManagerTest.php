...
test('hasFailed finds failed operations with .php suffix (legacy)', function (): void {
    // Create failed operation record with .php suffix
    Operation::query()->create([
        'name' => 'legacy_failed_operation.php',
        'type' => 'sync',
        'state' => 'failed',
        'executed_at' => now(),
        'failed_at' => now(),
...
test('getErrors retrieves errors for operations with .php suffix (legacy)', function (): void {
    // Create failed operation with error
    $operationRecord = Operation::query()->create([
        'name' => 'legacy_error_operation.php',
        'type' => 'sync',
        'state' => 'failed',
        'executed_at' => now(),
        'failed_at' => now(),
...
test('rollback finds rollbackable operations with .php suffix (legacy)', function (): void {
    // Create rollbackable operation record with .php suffix
    Operation::query()->create([
        'name' => 'legacy_rollback_operation.php',
        'type' => 'sync',
        'state' => 'completed',
        'executed_at' => now(),
        'completed_at' => now(),
