...
PHP;
            ...
            $record = OperationModel::query()->where('name', '2024_01_01_000000_timestamp_test')->first();
...
PHP;
            ...
            $initialRecord = OperationModel::query()->create([
                'name' => '2024_01_01_000000_repeat_op',
                'type' => ExecutionMethod::Batch,
...
PHP;
            ...
            OperationModel::query()->create([
                'name' => '2024_01_01_000000_no_repeat_op',
                'type' => ExecutionMethod::Batch,
                'executed_at' => now(),
                'completed_at' => now(),
                'state' => OperationState::Completed,
...
PHP;
            ...
            $record = OperationModel::query()->where('name', '2024_01_01_000000_type_test')->first();
            expect($record)->not->toBeNull();
