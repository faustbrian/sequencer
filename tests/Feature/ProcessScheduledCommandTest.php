...
PHP;
            ...
            // Mark operation as completed in database (name without .php extension)
            OperationModel::query()->create([
                'name' => '2025_11_08_120000_CompletedOperation',
                'type' => 'scheduled',
...
return new class implements \Cline\Sequencer\Contracts\Operation {
    public function handle(): void {
        throw \Tests\Support\Exceptions\TestException::runtimeError('This should not execute');
    }
};
PHP;
...
PHP;
            ...
            // Mark operation as completed in database (name without .php extension)
            OperationModel::query()->create([
                'name' => '2025_11_06_120000_CompletedFromRepeatOperation',
                'type' => 'scheduled',
