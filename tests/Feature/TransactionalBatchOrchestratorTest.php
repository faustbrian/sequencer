...
PHP;
            ...
            $firstOp = OperationModel::query()->where('name', '2024_01_01_000000_first_op')->first();
            ...
            $secondOp = OperationModel::query()->where('name', '2024_01_01_000001_second_op')->first();
...
PHP;
        ...
        test('rollback processes completed operations in reverse order', function (): void {
            ...
            $record1 = OperationModel::query()->create([
                'name' => '2024_01_01_000000_first_rollback_op',
            ...
            $record2 = OperationModel::query()->create([
                'name' => '2024_01_01_000001_second_rollback_op',
                'type' => ExecutionMethod::TransactionalBatch,
                'state' => OperationState::Completed,
            ...
            $record3 = OperationModel::query()->create([
                'name' => '2024_01_01_000002_third_rollback_op',
                'type' => ExecutionMethod::TransactionalBatch,
                'state' => OperationState::Completed,
                'executed_at' => now(),
                'completed_at' => now(),
...
PHP;
            ...
            OperationModel::query()->create([
                'name' => '2024_01_01_000000_findable_op',
                'type' => ExecutionMethod::TransactionalBatch,
                'executed_at' => now(),
                'completed_at' => now(),
                'state' => OperationState::Completed,
            ...
            OperationModel::query()->create([
                'name' => '2024_01_01_000001_another_op',
                'type' => ExecutionMethod::TransactionalBatch,
                'executed_at' => now(),
                'completed_at' => now(),
                'state' => OperationState::Completed,
            ...
            // Test finding first operation (without .php suffix)
            $result1 = $method->invoke($orchestrator, '2024_01_01_000000_findable_op');

            // Test finding second operation (without .php suffix)
            $result2 = $method->invoke($orchestrator, '2024_01_01_000001_another_op');

            // Test finding non-existent operation
            $result3 = $method->invoke($orchestrator, 'non_existent_operation');
            ...
            expect($result1['name'])->toBe('2024_01_01_000000_findable_op');
            expect($result1['class'])->toContain('2024_01_01_000000_findable_op.php');

            expect($result2)->toBeArray();
            expect($result2['name'])->toBe('2024_01_01_000001_another_op');
