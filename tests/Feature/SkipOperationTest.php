...
describe('Skip Operation Feature Tests', function (): void {
    ...
    describe('basic skip functionality', function (): void {
        test('operation can be skipped using SkipOperationException::create()', function (): void {
            // Arrange
...
PHP;
    ...
    describe('skip vs ConditionalExecution comparison', function (): void {
        test('ConditionalExecution prevents execution while SkipOperationException handles runtime skips', function (): void {
...
PHP;
            ...
            // Arrange - SkipOperationException operation
            $skipContent = <<<'PHP'
<?php
use Cline\Sequencer\Contracts\Operation;
use Cline\Sequencer\Exceptions\SkipOperationException;
...
return new class() implements Operation {
    public function handle(): void {
        ...
        throw SkipOperationException::create('Runtime skip decision');
    }
};
PHP;
...
return new class() implements Operation, WithinTransaction {
    public function handle(): void {
        ...
        throw SkipOperationException::create('Decided to skip inside transaction');
    }
};
PHP;
...
return new class() implements Operation {
    public function handle(): void {
        throw SkipOperationException::create('Skipped operation');
    }
};
PHP;
...
return new class() implements Operation {
    public function handle(): void {
        throw SkipOperationException::create('No error should be recorded');
    }
};
PHP;
...
return new class() implements Operation {
    public function handle(): void {
        throw SkipOperationException::create('Custom channel test');
    }
};
PHP;
